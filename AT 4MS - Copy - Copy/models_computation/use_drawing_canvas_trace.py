...
def load_model():
    model_path = "models_computation/Drawing_canvas_trace.keras"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Drawing Canvas Trace Model Inference")
    parser.add_argument('--image', type=str, required=True, help='Path to input image')
    parser.add_argument('--model', type=str, default='Drawing_canvas_trace.keras', help='Path to model file')
...
def main():
    ...
    img_array = preprocess_image(args.image, target_size=(128, 128))
...
# Example usage:
# python use_drawing_canvas_trace.py --image trace.png --classes "Circle,Square,Triangle"